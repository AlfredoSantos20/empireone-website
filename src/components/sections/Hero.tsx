...
export function Hero() {
  return (
    <section id="home" className="relative overflow-hidden pt-32 pb-24 sm:pt-40 md:pt-44">
      <AnimatedBackground />
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <motion.div variants={container} initial="hidden" animate="show" className="flex flex-col items-start gap-6">
          ...
          <motion.h1
            variants={item}
            className="text-left text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl lg:text-[64px]"
          >
            Building{" "}
          ...
          <motion.div variants={item} className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <Button as="a" href="#portfolio" size="lg" variant="secondary">
