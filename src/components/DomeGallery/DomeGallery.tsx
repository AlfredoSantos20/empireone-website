...
export default function DomeGallery({
  ...
  // Slow, continuous auto-rotation (Earth-like)
  useEffect(() => {
    ...
    const loop = (now) => {
      ...
      last = now;
      const enlarging = rootRef.current?.getAttribute('data-enlarging') === 'true';
      if (!draggingRef.current && !enlarging) {
  ...
  const openItemFromElement = useCallback(
    el => {
      ...
      const wantsResize = openedImageWidth || openedImageHeight || openToTileSize;
      if (wantsResize) {
        const onFirstEnd = ev => {
          ...
          const tempWidth = openToTileSize
            ? `${tileR.width}px`
            : (openedImageWidth || `${frameR.width}px`);
          const tempHeight = openToTileSize
            ? `${tileR.height}px`
      ...
      <main ref={mainRef} className="sphere-main">
              ...
              >
                ...
                >
                  <img
                    ...
                    alt={it.alt}
                    onError={(e) => {
                      if (e.currentTarget.src !== '/assets/images/as.png') {
                        e.currentTarget.src = '/assets/images/as.png';
                      }
                    }}
                  />
                </div>
        ...
        <div className="viewer" ref={viewerRef}>
          <button
            ...
            className="close-btn"
            aria-label="Close"
            onClick={() => scrimRef.current?.click()}
          >
            ×
          </button>
